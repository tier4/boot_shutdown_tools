...
{
  boot_shutdown_api_msgs__srv__ExecuteShutdown_Request * msg = (boot_shutdown_api_msgs__srv__ExecuteShutdown_Request *)malloc(sizeof(boot_shutdown_api_msgs__srv__ExecuteShutdown_Request));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(boot_shutdown_api_msgs__srv__ExecuteShutdown_Request));
  bool success = boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
{
  if (msg) {
    boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__fini(msg);
  }
  free(msg);
}
...
boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__Sequence__init(boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__Sequence * array, size_t size)
{
  ...
  boot_shutdown_api_msgs__srv__ExecuteShutdown_Request * data = NULL;
  if (size) {
    data = (boot_shutdown_api_msgs__srv__ExecuteShutdown_Request *)calloc(size, sizeof(boot_shutdown_api_msgs__srv__ExecuteShutdown_Request));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__Sequence__fini(boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__Sequence * array = (boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__Sequence *)malloc(sizeof(boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__Sequence__fini(array);
  }
  free(array);
}
...
boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__Sequence__are_equal(const boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__Sequence * lhs, const boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(boot_shutdown_api_msgs__srv__ExecuteShutdown_Request);
    boot_shutdown_api_msgs__srv__ExecuteShutdown_Request * data =
      (boot_shutdown_api_msgs__srv__ExecuteShutdown_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!boot_shutdown_api_msgs__srv__ExecuteShutdown_Request__copy(
...
boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__init(boot_shutdown_api_msgs__srv__ExecuteShutdown_Response * msg)
{
  ...
  if (!autoware_adapi_v1_msgs__msg__ResponseStatus__init(&msg->status)) {
    boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__fini(msg);
    return false;
  }
  // power_off_time
...
{
  boot_shutdown_api_msgs__srv__ExecuteShutdown_Response * msg = (boot_shutdown_api_msgs__srv__ExecuteShutdown_Response *)malloc(sizeof(boot_shutdown_api_msgs__srv__ExecuteShutdown_Response));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(boot_shutdown_api_msgs__srv__ExecuteShutdown_Response));
  bool success = boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__Sequence__init(boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__Sequence * array, size_t size)
{
  ...
  boot_shutdown_api_msgs__srv__ExecuteShutdown_Response * data = NULL;
  if (size) {
    data = (boot_shutdown_api_msgs__srv__ExecuteShutdown_Response *)calloc(size, sizeof(boot_shutdown_api_msgs__srv__ExecuteShutdown_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__Sequence__fini(boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
{
  boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__Sequence * array = (boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__Sequence *)malloc(sizeof(boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__Sequence__fini(array);
  }
  free(array);
}
...
boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__Sequence__are_equal(const boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__Sequence * lhs, const boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(boot_shutdown_api_msgs__srv__ExecuteShutdown_Response);
    boot_shutdown_api_msgs__srv__ExecuteShutdown_Response * data =
      (boot_shutdown_api_msgs__srv__ExecuteShutdown_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!boot_shutdown_api_msgs__srv__ExecuteShutdown_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
