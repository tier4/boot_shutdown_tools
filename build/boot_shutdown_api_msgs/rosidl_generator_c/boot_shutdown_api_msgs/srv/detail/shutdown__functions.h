...
#ifndef BOOT_SHUTDOWN_API_MSGS__SRV__DETAIL__SHUTDOWN__FUNCTIONS_H_
#define BOOT_SHUTDOWN_API_MSGS__SRV__DETAIL__SHUTDOWN__FUNCTIONS_H_
...
/// Initialize srv/Shutdown message.
/**
...
/// Create srv/Shutdown message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * boot_shutdown_api_msgs__srv__Shutdown_Request__init().
...
/// Destroy srv/Shutdown message.
/**
 * It calls
 * boot_shutdown_api_msgs__srv__Shutdown_Request__fini()
...
/// Check for srv/Shutdown message equality.
/**
...
/// Initialize array of srv/Shutdown messages.
/**
...
/// Finalize array of srv/Shutdown messages.
/**
 * It calls
 * boot_shutdown_api_msgs__srv__Shutdown_Request__fini()
...
/// Create array of srv/Shutdown messages.
/**
 * It allocates the memory for the array and calls
 * boot_shutdown_api_msgs__srv__Shutdown_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Shutdown messages.
/**
 * It calls
 * boot_shutdown_api_msgs__srv__Shutdown_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Shutdown message array equality.
/**
...
/// Copy an array of srv/Shutdown messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * boot_shutdown_api_msgs__srv__Shutdown_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_boot_shutdown_api_msgs
...
/**
 * It calls
 * boot_shutdown_api_msgs__srv__Shutdown_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_boot_shutdown_api_msgs
...
/**
 * It allocates the memory for the array and calls
 * boot_shutdown_api_msgs__srv__Shutdown_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_boot_shutdown_api_msgs
...
/**
 * It calls
 * boot_shutdown_api_msgs__srv__Shutdown_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BOOT_SHUTDOWN_API_MSGS__SRV__DETAIL__SHUTDOWN__FUNCTIONS_H_
