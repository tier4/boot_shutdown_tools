...
#include "boot_shutdown_api_msgs/srv/detail/shutdown__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const boot_shutdown_api_msgs::srv::Shutdown_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<boot_shutdown_api_msgs::srv::Shutdown_Request *>(
    untyped_ros_message);
...
{
  return max_serialized_size_Shutdown_Request(full_bounded, 0);
}
...
{
  return &boot_shutdown_api_msgs::srv::typesupport_fastrtps_cpp::_Shutdown_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const boot_shutdown_api_msgs::srv::Shutdown_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<boot_shutdown_api_msgs::srv::Shutdown_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return max_serialized_size_Shutdown_Response(full_bounded, 0);
}
...
{
  return &boot_shutdown_api_msgs::srv::typesupport_fastrtps_cpp::_Shutdown_Response__handle;
}
...
{
  return &boot_shutdown_api_msgs::srv::typesupport_fastrtps_cpp::_Shutdown__handle;
}
