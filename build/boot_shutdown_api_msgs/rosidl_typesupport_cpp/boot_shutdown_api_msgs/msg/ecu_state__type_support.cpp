...
static const _EcuState_type_support_symbol_names_t _EcuState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, boot_shutdown_api_msgs, msg, EcuState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, boot_shutdown_api_msgs, msg, EcuState)),
  }
};
...
{
  return &::boot_shutdown_api_msgs::msg::rosidl_typesupport_cpp::EcuState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, boot_shutdown_api_msgs, msg, EcuState)() {
  return get_message_type_support_handle<boot_shutdown_api_msgs::msg::EcuState>();
}
