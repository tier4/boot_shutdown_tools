...
#define NODE_MAIN_LOGGER_NAME "boot_shutdown_interface"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libboot_shutdown_interface_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<boot_shutdown_interface::BootShutdownInterface>";
