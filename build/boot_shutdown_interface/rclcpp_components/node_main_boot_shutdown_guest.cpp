...
#define NODE_MAIN_LOGGER_NAME "boot_shutdown_guest"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libboot_shutdown_guest_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<boot_shutdown_interface::BootShutdownGuest>";
